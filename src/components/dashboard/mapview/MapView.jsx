 ...
 * field's real boundary is usually a rotated/irregular polygon — so for
 * anything but a perfect north-aligned rectangle, the raster overflows
 * past the field's true edges into the padding around it. Build a CSS
 * clip-path (percentages relative to the image's own bounds) so the
 * rendered raster is masked to the field's actual shape.
 */
