...
const AddFarm = ({ selectedFarm }) => {
    ...
    const handleSubmit = async (e) => { 
        ...
        // Use selectedFarmState instead of selectedFarm
        ...
        try {
            setUpdating(true);
            // Use selectedFarmState._id instead of selectedFarm._id
            await dispatch(updateFarmField({ fieldId: selectedFarmState._id, updatedData })).unwrap()
    ...
    const handleDeleteConfirm = async () => {
        try {
            // Use selectedFarmState instead of selectedFarm
            if (!selectedFarmState?._id) return message.error("No farm selected to delete!");
