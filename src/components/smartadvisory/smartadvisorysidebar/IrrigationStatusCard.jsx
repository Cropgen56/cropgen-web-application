  ...
  return (
    <div className={`bg-[#2F4F3A] w-full h-full rounded-[16px] ${isTablet ? "p-[2px]" : "p-3"} text-white flex flex-col justify-between`}>
      ...
      <div className="flex justify-between items-center mb-[2px]">
        ...
        <img className={`${isTablet ? "w-[10px] h-[10px]" : "w-[20px]"}`} src={img4} alt="" />
      </div>
      ...
      {/* Footer */}
      <div className={`flex justify-between items-center ${isTablet ? "mt-[4px] text-[7px]" : "mt-6 text-sm"} font-semibold`}>
