...
export default AddFieldSidebar;
 ...
 <div className="flex-1 flex flex-col justify-center items-center overflow-y-auto px-3 pt-3 text-[#344e41] z-50">
    <div className="w-full max-w-md">
      <h5 className="text-[#344e41] mb-4 text-center text-lg font-semibold">Crop Details</h5>

      <div className="flex flex-col gap-4">
        {/* FARM NAME */}
        <div className="flex flex-col gap-1">
          <label htmlFor="farm-name" className="font-semibold text-sm">Farm Name</label>
          <input
            type="text"
            value={farmName}
            onChange={(e) => setFarmName(e.target.value)}
        ...
        {/* CROP NAME */}
        <div className="flex flex-col gap-1">
          <label htmlFor="cropName" className="font-semibold text-sm">Crop Name</label>
          <select
            value={cropName}
            onChange={(e) => setCropName(e.target.value)}
        ...
        {/* VARIETY */}
        <div className="flex flex-col gap-1">
          <label htmlFor="variety" className="font-semibold text-sm">Variety</label>
          <input
            type="text"
            value={variety}
            onChange={(e) => setVariety(e.target.value)}
        ...
        {/* SOWING DATE */}
        <div className="flex flex-col gap-1">
          <label htmlFor="sowingDate" className="font-semibold text-sm">Sowing Date</label>
          <input
            type="date"
            id="sowingDate"
            name="sowingDate"
        ...
        {/* TYPE OF IRRIGATION */}
        <div className="flex flex-col gap-1">
          <label htmlFor="irrigationType" className="font-semibold text-sm">Type Of Irrigation</label>
          <select
            className="border border-[#344e41] w-full outline-none rounded px-3 py-2 bg-[#344E41] text-gray-300"
            value={typeOfIrrigation}
            onChange={(e) => setTypeOfIrrigation(e.target.value)}
        ...
        {/* TYPE OF FARMING */}
        <div className="flex flex-col gap-1">
          <label htmlFor="typeOfFarming" className="font-semibold text-sm">Type Of Farming</label>
          <select
            className="border border-[#344e41] w-full outline-none rounded px-3 py-2 bg-[#344E41] text-gray-300"
            value={typeOfFarming}
            onChange={(e) => setTypeOfFarming(e.target.value)}
