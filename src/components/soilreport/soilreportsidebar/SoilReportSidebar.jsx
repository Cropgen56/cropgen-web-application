...
const FieldInfo = ({ title, area, lat, lon, isSelected, onClick }) => (
  <div
    className={`soip-report-info ${isSelected ? "selected-soip-report" : ""}`}
    onClick={onClick}
  >
    <FieldIcon isSelected={isSelected} />
    <div className="soip-report-operations">
      <h4 className={`${isSelected ? "selected-title" : ""}`}>{title}</h4>
      <p className="ha">{area}</p>
      <div className="soip-report-details">
        <p>{lat} N</p>
        <p>{lon} E</p>
      </div>
    </div>
...
const SoilReportSidebar = ({ selectedOperation, setSelectedOperation }) => {
  ...
  return (
    <>
      {isSidebarVisible && (
        <div className="soip-report-sidebar">
          <div className="soip-report-heading">
            <div className="soip-report-first-row">
              <Operation2 />
              <h2>Soil Report</h2>
              <svg
                width="30"
                height="30"
                className="soip-report-close-button"
                viewBox="0 0 30 30"
                fill="none"
            ...
            <div className="soip-report-search">
          ...
          <div className="soip-report-field">
            <h2>Field</h2>
